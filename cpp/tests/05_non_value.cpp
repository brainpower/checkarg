...
int callback_b(CheckArg*const, const string &o, const string & ) { cb_opt = o; return 0; }
int callback_d(CheckArg*const, const string &o, const string & ) { cb_opt = o; return 0; }
...
TEST_CASE("options: long non-value options (lambda callbacks)", "[non-val-opt]") {
  ...
  ca.add(
    'b', "beta",
    [&](auto, const auto &opt, auto&) -> int { cb_opt2 = opt; return cb_rc; },
    "non-value opt b");
  ca.add(
    "gamma",
